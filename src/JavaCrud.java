...
//		image changes
	    ...
	    frame.setBounds(100, 100, 1360, 767);
...
//	    Image backgroundImage = new ImageIcon("C:/Users/Windows/Downloads/SJCIT-logoooo.jpg").getImage();
		...
		panel.setBounds(524, 82, 309, 177);
...
//					table_load();
		...
		btnNewButton.setBounds(534, 272, 89, 46);
		...
		btnExit.setBounds(731, 272, 89, 46);
		...
		btnClear.setBounds(633, 272, 89, 46);
		...
		btnUpdate.setBounds(276, 592, 117, 46);
		...
		btnClear_2.setBounds(457, 592, 89, 46);
		frame.getContentPane().add(btnClear_2);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(116, 355, 1122, 219);
